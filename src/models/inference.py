...
def parse_args(args):
    ...
    parser.add_argument('--path_to_tokenizerjson', type=str,default=None, help="Path to the tokenizer json file")

    parser.add_argument('--path_to_save_dir',default=None, type=str, help="Path to the save directory json file")
